...
class Cart
{
    ...
    {
        $this->cart_id     = !empty($data['cart_id']) ? $data['cart_id'] : '';
        $this->customer_id = !empty($data['customer_id']) ? $data['customer_id'] : '';
        $this->order_datetime  = !empty($data['order_datetime']) ? $data['order_datetime'] : '';
    ...
    {
        $this->sub_total = $cartTotals->sub_total;
        $this->total_amount = $cartTotals->total_amount;
        $this->total_weight = $cartTotals->total_weight;
    }
